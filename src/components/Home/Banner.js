			...
			<div className='hero h-[calc(100vh_-_5rem)]'>
				<div className='hero-content flex md:flex-row-reverse'>
					...
					<div className='w-1/2'>
						...
						<p className='py-6'>
							Following our old legacy, we have launched our best
							selling offer once again after the pandemic. So what
							are you waiting for? Let's dive in!
						</p>
						<button className='btn btn-primary font-bold text-accent'>
							Learn More
						</button>
					</div>
				</div>
