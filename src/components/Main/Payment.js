...
const stripePromise = loadStripe(
	"pk_test_51L4Iy4JpuNWuxCtplL2nHPQMZ9JOBpLRnYFGnOcMcHKt4fwaBOEpu7otwvPJ00rN4ZTq2vtJVZuee0GLuqwuicOi00F5w34N1z"
);
					...
					<div className='w-1/2'>
						<div className='card bg-base-100 rounded-lg shadow-xl'>
							<div className='card-body text-sm'>
								<h2 className='card-title justify-center my-2 text-2xl'>
									Order Details
								</h2>
								<div>
